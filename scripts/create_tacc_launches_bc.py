...
export WORKDIR=$WORK/Code/behavioral_cloning_atari/
'''
...
def create_launch_file(envname):
    ...
    schedule_options = "#SBATCH -J BC_best_" + envname +    "      	# Job name\n"
    
    output_name = "#SBATCH -o /work/05933/dsbrown/maverick/output/logs/BC_best_" + envname + ".o%j  # Name of stdout output file (%j expands to jobid) \n"
    control_file = "export CONTROL_FILE=bc_commands_best_"+ envname + "\n"
    ...
    f = open("bc_best_" + envname + ".slurm",'w')
