...
def create_launch_file(envname):
    ...
    schedule_options = "#SBATCH -J BCO_" + envname +    "      	# Job name\n"
    
    output_name = "#SBATCH -o /work/05933/dsbrown/maverick/output/logs/BCO_" + envname + ".o%j  # Name of stdout output file (%j expands to jobid) \n"
    ...
    f = open("sorted_" + envname + ".slurm",'w')
